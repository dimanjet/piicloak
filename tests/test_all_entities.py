...
class TestPersonalIdentifiableInformation:
    ...
    def test_phone_number_detection(self, cloak):
        ...
        test_cases = ["(555) 123-4567", "555-123-4567", "555.123.4567"]
        detected_count = 0
    ...
    def test_us_ssn_detection(self, cloak):
        ...
        test_cases = ["123-45-6789", "123 45 6789"]
    ...
    def test_address_detection(self, cloak):
        ...
        test_cases = ["123 Main Street, New York, NY 10001", "456 Oak Avenue", "P.O. Box 12345"]
...
class TestFinancialInformation:
    ...
    def test_credit_card_detection(self, cloak):
        ...
        for card in test_cases:
            ...
            result = cloak.analyze(text)
            if result.contains_pii and any(
                e["type"] == "CREDIT_CARD" for e in result.entities_found
            ):
                detected_count += 1
    ...
    def test_iban_code_detection(self, cloak):
        ...
        test_cases = ["GB82 WEST 1234 5698 7654 32", "DE89370400440532013000"]
    ...
    def test_bank_account_detection(self, cloak):
        ...
        test_cases = ["Account: 021000021", "ACC-123456789", "A-987654321"]  # Routing number
    ...
    def test_tax_id_detection(self, cloak):
        ...
        test_cases = ["EIN: 12-3456789", "TIN: 98-7654321"]
...
class TestOrganizationalData:
    ...
    def test_account_id_detection(self, cloak):
        ...
        test_cases = ["ACC-123456", "A-987654", "ACCT-2024-001"]
...
class TestLegalDocuments:
    ...
    def test_case_number_detection(self, cloak):
        ...
        test_cases = ["Case No. 1:24-cv-12345", "CV-2024-001234", "CR-2023-567890"]
    ...
    def test_contract_number_detection(self, cloak):
        ...
        test_cases = ["CTR-2024-001234", "POL-2024-567890", "CONT-2023-999"]
...
class TestTechnicalAndSecurity:
    ...
    def test_ip_address_detection(self, cloak):
        ...
        test_cases = ["192.168.1.1", "10.0.0.1", "2001:0db8:85a3:0000:0000:8a2e:0370:7334"]
...
class TestHealthcareAndOther:
    ...
    def test_medical_license_detection(self, cloak):
        ...
        test_cases = ["MD-123456", "License: ML-987654"]
    ...
    def test_location_detection(self, cloak):
        ...
        test_cases = ["I live in New York", "Visit San Francisco", "Located in London"]
        for text in test_cases:
            result = cloak.analyze(text)
    ...
    def test_date_time_detection(self, cloak):
        ...
        test_cases = ["Meeting on 2024-01-20", "Born on January 20th, 1990", "Expires: 12/31/2025"]
        for text in test_cases:
            result = cloak.analyze(text)
